...
# scheduling_data_raw <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/historical_data.rds")
...
# master_amb_mapping <- as.data.frame(read_excel("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/server-upload-updated/master_amb_mapping_updated.xlsx", col_types = "text"))
...
# sessional_prov_mapping <- as.data.frame(read_excel("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/server-upload-updated/master_amb_sessional_provider_mapping.xlsx", col_types = "text"))

scheduling_data_raw <- left_join(scheduling_data_raw, sessional_prov_mapping, by = c("Department","Provider"))
...
# appt_type_mapping <- as.data.frame(read_excel("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/server-upload-updated/master_amb_appt_type_mapping.xlsx", col_types = "text"))
...
# dept_zip_code_ref <- read_csv("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/server-upload-updated/Department_Zip_Code.csv")
...
# referrals <- readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/referral_vol.rds")
...
```{r Save Output Data 1, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r Save Output Data 2, echo = FALSE, warning = FALSE, message = FALSE}
...
rm(waitTime_dist_specialty)
rm(waitTime_mshs)
rm(waitTime_mshs)
rm(waitTime_site)
rm(waitTime_prov)
rm(waitTime_dist_specialty_group)
rm(waitTime_dist_site_group_office)
rm(waitTime_mshs_group)
rm(waitTime_site_group)
rm(waitTime_site_group)
invisible(gc())
```
...
```{r Save Output Data 3, echo = FALSE, warning = FALSE, message = FALSE}
...
rm(waitTime_dist_specialty_office)
rm(waitTime_mshs_office)
rm(waitTime_mshs_office)
rm(waitTime_site_office)
rm(waitTime_prov_office)
rm(waitTime_dist_specialty_group_office)
rm(waitTime_dist_site_group_office_office)
rm(waitTime_mshs_group_office)
rm(waitTime_site_group_office)
rm(waitTime_site_group_office)
invisible(gc())
```
...
```{r Save Output Data 4, echo = FALSE, warning = FALSE, message = FALSE}
...
rm(waitTime_dist_specialty_ytd)
rm(waitTime_dist_site_ytd)
rm(waitTime_mshs_ytd)
rm(waitTime_site_ytd)
rm(waitTime_prov_ytd)
rm(waitTime_dist_specialty_group_ytd)
rm(waitTime_dist_site_group_office_ytd)
rm(waitTime_mshs_group_ytd)
rm(waitTime_site_group_ytd)
rm(waitTime_site_group_ytd)
invisible(gc())
```
...
```{r Save Output Data 5, echo = FALSE, warning = FALSE, message = FALSE}
...
rm(waitTime_dist_specialty_office_ytd)
rm(waitTime_dist_site_office_ytd)
rm(waitTime_mshs_office_ytd)
rm(waitTime_site_office_ytd)
rm(waitTime_prov_office_ytd)
rm(waitTime_dist_specialty_group_office_ytd)
rm(waitTime_dist_site_group_office_ytd)
rm(waitTime_mshs_group_office_ytd)
rm(waitTime_site_group_office_ytd)
rm(waitTime_site_group_office_ytd)
invisible(gc())
```
...
```{r Save Output Data 6, echo = FALSE, warning = FALSE, message = FALSE}
